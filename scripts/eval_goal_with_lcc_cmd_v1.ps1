param(
    ...
    [string]$LccModel = "D:\projects\wukong_ai\checkpoints\v63_lcc_cmd_v1_history\goal_bc_v56_history_best_action.pt"
)
...
& "C:\Python\python.exe" -u "apps\run_inference_v2.py" `
    ...
    --duration $Duration `
    --conf-threshold 0.35 `
    --telemetry "D:\projects\wukong_ai\telemetry\v63_goal_with_lcc_cmd${CommandId}_eval_$RunId.csv"
